...
plt.title("Top 75 Games: Positive vs Negative Reviews FILTERED")
plt.legend()
plt.tight_layout()

plt.savefig("FINALtop50_positive_negativeFILTERED.png", dpi=200)
plt.show()

print("Saved chart to FINALtop50_positive_negativeFILTERED.png")