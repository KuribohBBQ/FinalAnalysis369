...
plt.title("Top 50 Games by Total Reviews – Positive Review Percentage")
plt.tight_layout()

plt.savefig("FINALtop50_review_score_bar_chart.png", dpi=200)
plt.show()

print("Bar chart saved as top50_review_score_bar_chart.png")